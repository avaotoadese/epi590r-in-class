...
```{r}
#| label: tbl-one
#| tbl-cap: "Descrptive stats stratified by sex"
...
@tbl-one contains descriptive stats
...
People slept an average of `r mean_sleep_weekend` hours during weekends.
...
inline_text(table1, variable = "region_cat", column = "female", pattern = "{n}/{N} ({p}%)")
```
